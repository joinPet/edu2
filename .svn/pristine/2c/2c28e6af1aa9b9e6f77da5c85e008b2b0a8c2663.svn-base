    ...
    <div class="login-form">
      ...
      <form action="/member/login_select.do" method="post"> 
      	<div class="group">
	          ...
	          <input name="user_id" id="user" type="text" class="input">
	        </div>
	        <div class="group">
	          <label for="pass" class="label">비밀번호</label>
	          <input name="user_pw" id="pass" type="password" class="input" data-type="password">
	        </div>
      ...
      <hr>
        <div class="foot-lnk">
          <a class="btn btn-sm" href="/member/ForgotId.do">아이디, 비밀번호 찾기</a>
        </div>
      </div>
