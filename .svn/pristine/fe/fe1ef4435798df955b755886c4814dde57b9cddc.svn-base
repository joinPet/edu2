...
<div class="row">
	...
	<!-- /Breadcrumb -->
	<div class="col-sm-10">
		<h2 class="bd-title border-bottom pb-3 mb-3">My Profile</h2>
		<div class="row">
			<div class="col-sm-4">
				<div class="card">
					<div class="card-body">
						<div class="d-flex flex-column align-items-center text-center">
							<div class="mt-3">
								<h4><c:out value ="${memberinfo.user_id}"/></h4>
								<p class="text-secondary mb-1"><c:out value ="${memberinfo.user_dong}"/></p>
								<p class="text-muted font-size-sm" style="text-transform:uppercase"><c:out value ="${memberinfo.user_mbti}"/></p>
								<button class="btn btn-outline-dark" onclick="location.href='/profile/petmanage.do'">내 반려동물 보기</button>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="card mb-3">
					<div class="card-body">
						<div class="row">
							...
							<div class="col-sm-9 text-secondary"><c:out value ="${memberinfo.user_id}"/></div>
						</div>
						<hr>
						<div class="row">
							<div class="col-sm-3">
								<h6 class="mb-0">USER MBTI</h6>
							</div>
							<div class="col-sm-9 text-secondary" style="text-transform:uppercase"><c:out value ="${memberinfo.user_mbti}"/></div>
						</div>
						<hr>
						<div class="row">
							<div class="col-sm-3">
							...
							<div class="col-sm-9 text-secondary"><c:out value ="${memberinfo.user_email}"/></div>
						</div>
						<hr>
						<div class="row">
							<div class="col-sm-3">
								<h6 class="mb-0">USER DONG</h6>
							</div>
							<div class="col-sm-9 text-secondary"><c:out value ="${memberinfo.user_dong}"/></div>
						</div>
						<hr>
						<div class="row">
							<div class="col-sm-3">
							...
							<div class="col-sm-9 text-secondary"><c:out value ="${memberinfo.user_info}"/></div>
						</div>
<!-- 						<div class="row">
							<div class="col-sm-12">
